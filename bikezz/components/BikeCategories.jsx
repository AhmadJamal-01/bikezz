...
const BikeCategories = ({bikes}) => {
   ...
   useEffect(()=> {
    const filtered = bikes.filter((bike)=> {
        const categoryMatch = category === 'all' ? bikes : bike.categories.some((categ)=> 
            categ.name === category)
  ...
  return (
    <section className='min-h-[1200] py-10'>
            ...
            <div className="flex flex-col"> 
                ...
                xl:fixed *:'>
                    <RadioGroup defaultValue='all' className='flex flex-col gap-6 mb-12'>
                        ...
                        <div className='flex items-center space-x-2'>
                            <RadioGroupItem value='professional' id='professional' onClick={()=> 
                    ...
                    <div className='max-w-56'>
                        <div className='text-lg mb-4 font-medium '>
                            ...
                            (
                                ...
                                filteredBikes === 0 ? `${filteredBikes.length} items` : 
